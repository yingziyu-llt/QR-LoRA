...
OUTPUT_DIR="./exps_SD3/$(date +%m%d-%H%M%S)-${TRIGGER_NAME}-${RANK}"
...
accelerate launch --num_processes=$NUM_GPUS train_scripts/train_qrlora_SD3_svd.py \
